...
**Washington Post standing search (daily):** Run `site:washingtonpost.com after:[DATE-48H]` with the DC federal-cultural cluster terms above — National Mall, Reflecting Pool, America 250, triumphal arch, Smithsonian, NEA, NEH, GSA fine arts, Cultural Landscape Foundation — plus any active case names from the 046 / 005 / 069 cluster. Substitute the actual date 48 hours before the run for [DATE-48H] (e.g. `after:2026-06-27` for a June 29 run). **The date filter is mandatory** — without it the search surfaces prominent older articles rather than breaking coverage. WaPo is the primary outlet for National Mall, federal arts institution, and America 250 coverage; this sweep runs every day regardless of trawl region. Supplements (does not replace) the general dragnet.
