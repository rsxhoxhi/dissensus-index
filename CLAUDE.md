...
- **Urgent Matter** (urgentmatter.press; reviewed 28 August 2026) — single-author art-law newsletter by journalist Adam Schrader (prior bylines at ARTnews and UPI; earlier tabloid work at The Sun / Page Six), launched 2026, working substantially from primary court documents. **Does not meet the exclusion bar** — no fabrication record, and document-based reporting is inherently verifiable. But as a sub-year-old outlet with a single editorial voice it has no established track record yet. **Posture: a corroborated / secondary source, and citable for its own attributed primary-document reporting; not a sole source for a contested claim, pending track record.** Artforum has cited and linked it — a positive signal from an established desk. Revisit as the track record develops.
