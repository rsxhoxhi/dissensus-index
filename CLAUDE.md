...
**Washington Post standing search (daily):** Run `site:washingtonpost.com` with the DC federal-cultural cluster terms above — National Mall, Reflecting Pool, America 250, triumphal arch, Smithsonian, NEA, NEH, GSA fine arts, Cultural Landscape Foundation — plus any active case names from the 046 / 005 / 069 cluster. WaPo is the primary outlet for National Mall, federal arts institution, and America 250 coverage; this sweep runs every day regardless of trawl region. Supplements (does not replace) the general dragnet — other outlets (NYT, NPR, Politico) may break federal-cultural stories too.
